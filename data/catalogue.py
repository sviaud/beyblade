...
CATALOGUE = [
    ...
    {'slug': 'dran-buster-1-60a',     'name': 'Dran Buster 1-60A',      'ref': 'UX-01',  'gamme': 'beyblade-x', 'type': 'attaque',         'year': 2024, 'score': 9.0, 'image': 'dran-buster.webp',    'asin': 'B0CV7HF3W6', 'owner': 'Bird Maru',         'tagline': "Évolution Unique-X de Dran Sword (alliage métal)"},
    ...
    {'slug': 'cyclone-roktavor-r7',   'name': 'Cyclone Roktavor R7',    'ref': 'F4067', 'gamme': 'beyblade-burst', 'type': 'attaque',        'year': 2022, 'score': 8.0, 'image': 'cyclone-roktavor.webp', 'asin': 'B09TGD75BP', 'owner': 'Aiger Akabane',  'tagline': "Attaquante Quad Drive 4 modes interchangeables"},
    {'slug': 'vanish-fafnir-f7',      'name': 'Vanish Fafnir F7',       'ref': 'F3966', 'gamme': 'beyblade-burst', 'type': 'stamina-gauche', 'year': 2022, 'score': 8.2, 'image': 'vanish-fafnir.webp',    'asin': 'B09H17H8CD', 'owner': 'Free de la Hoya', 'tagline': "Stamina culte Spin Steal de la lignée Fafnir"},
    ...
    {'slug': 'earth-eagle-145wd',        'name': 'Earth Eagle 145WD',        'ref': 'BB-47',  'gamme': 'beyblade-metal-fusion', 'type': 'defense',         'year': 2010, 'score': 7.6, 'image': 'earth-eagle.webp',     'asin': 'B0050OMBU8', 'owner': 'Tsubasa Otori',  'tagline': "Défense endurance (Earth Aquila chez Hasbro EU)"},
