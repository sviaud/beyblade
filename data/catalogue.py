...
#   image (str|None)  — fichier principal dans /static/img/ (ex: 'cobalt-dragoon.webp')
#   images (list[str])— carrousel : liste de fichiers (la première est le main).
#                       Si absent, on tombe sur [image] uniquement.
...
CATALOGUE = [
    ...
    {'slug': 'hells-scythe-4-60t',    'name': 'Hells Scythe 4-60T',     'ref': 'BX-02',  'gamme': 'beyblade-x', 'type': 'stamina',         'year': 2023, 'score': 8.3, 'image': 'hells-scythe.webp',   'images': ['hells-scythe.webp', 'hells-scythe-2.webp', 'hells-scythe-4.webp', 'hells-scythe-5.webp', 'hells-scythe-6.webp', 'hells-scythe-7.webp'], 'asin': 'B0C52C4L3T', 'owner': 'Multi',             'tagline': "Stamina-defense hybride du quatuor inaugural"},
    {'slug': 'cobalt-dragoon-2-60c',  'name': 'Cobalt Dragoon 2-60C',   'ref': 'BX-34',  'gamme': 'beyblade-x', 'type': 'attaque-gauche',  'year': 2024, 'score': 8.6, 'image': 'cobalt-dragoon.webp', 'images': ['cobalt-dragoon.webp', 'cobalt-dragoon-2.webp', 'cobalt-dragoon-3.webp', 'cobalt-dragoon-4.webp', 'cobalt-dragoon-5.webp', 'cobalt-dragoon-6.webp'], 'asin': 'B0D6MZB1VF', 'owner': 'Kuroda Hyo',        'tagline': "1ʳᵉ left-spin Beyblade X (Spin Steal)"},
    {'slug': 'dran-buster-1-60a',     'name': 'Dran Buster 1-60A',      'ref': 'UX-01',  'gamme': 'beyblade-x', 'type': 'attaque',         'year': 2024, 'score': 9.0, 'image': 'dran-buster.webp',    'images': ['dran-buster.webp', 'dran-buster-2.webp', 'dran-buster-4.webp', 'dran-buster-5.webp', 'dran-buster-6.webp', 'dran-buster-7.webp'], 'asin': 'B0CV7HF3W6', 'owner': 'Bird Maru',         'tagline': "Évolution Unique-X de Dran Sword (alliage métal)"},
    ...
    {'slug': 'cyclone-roktavor-r7',   'name': 'Cyclone Roktavor R7',    'ref': 'F4067', 'gamme': 'beyblade-burst', 'type': 'attaque',        'year': 2022, 'score': 8.0, 'image': 'cyclone-roktavor.webp', 'images': ['cyclone-roktavor.webp', 'cyclone-roktavor-3.webp', 'cyclone-roktavor-4.webp', 'cyclone-roktavor-5.webp', 'cyclone-roktavor-6.webp', 'cyclone-roktavor-7.webp', 'cyclone-roktavor-8.webp'], 'asin': 'B09TGD75BP', 'owner': 'Aiger Akabane',  'tagline': "Attaquante Quad Drive 4 modes interchangeables"},
    {'slug': 'vanish-fafnir-f7',      'name': 'Vanish Fafnir F7',       'ref': 'F3966', 'gamme': 'beyblade-burst', 'type': 'stamina-gauche', 'year': 2022, 'score': 8.2, 'image': 'vanish-fafnir.webp',    'images': ['vanish-fafnir.webp', 'vanish-fafnir-5.webp', 'vanish-fafnir-6.webp', 'vanish-fafnir-7.webp', 'vanish-fafnir-8.webp'], 'asin': 'B09H17H8CD', 'owner': 'Free de la Hoya', 'tagline': "Stamina culte Spin Steal de la lignée Fafnir"},
    {'slug': 'stellar-hyperion-h8',   'name': 'Stellar Hyperion H8',    'ref': 'F6809', 'gamme': 'beyblade-burst', 'type': 'attaque',        'year': 2023, 'score': 8.5, 'image': 'stellar-hyperion.webp', 'asin': None,         'owner': 'Lui Shirosagi',  'tagline': "Attaquante brutale Quad Strike (Hasbro EU/US)"},
    ...
    {'slug': 'storm-pegasus-105rf',      'name': 'Storm Pegasus 105RF',      'ref': 'BB-28',  'gamme': 'beyblade-metal-fusion', 'type': 'attaque',         'year': 2009, 'score': 8.0, 'image': 'storm-pegasus.webp',   'images': ['storm-pegasus.webp', 'storm-pegasus-2.webp', 'storm-pegasus-3.webp', 'storm-pegasus-4.webp'], 'asin': 'B004AY8ICE', 'owner': 'Ginga Hagane',   'tagline': "L'originelle de Ginga, inaugurale de la gamme"},
    ...
    {'slug': 'earth-eagle-145wd',        'name': 'Earth Eagle 145WD',        'ref': 'BB-47',  'gamme': 'beyblade-metal-fusion', 'type': 'defense',         'year': 2010, 'score': 7.6, 'image': 'earth-eagle.webp',     'images': ['earth-eagle.webp', 'earth-eagle-2.webp'], 'asin': 'B0050OMBU8', 'owner': 'Tsubasa Otori',  'tagline': "Défense endurance (Earth Aquila chez Hasbro EU)"},
